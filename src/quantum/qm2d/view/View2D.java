...
import quantum.qm2d.model.AreaPotential;
...
import quantum.qm2d.model.PointPotential;
...
import quantum.qmutil.ContourPlot;
...
public class View2D extends JPanel {
    ...
    private void draw(Graphics2D g) {
        ...
        if (frank) {
            ...
            MiscUtil.drawFrank(g2, getWidth() - frankLength - 10, getHeight() - dy);
        }
    }
