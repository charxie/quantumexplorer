...
import org.concord.qmutil.PastableTextPane;
...
class ConsoleTextPane extends PastableTextPane {
	...
	/**
	 * Custom key event processing for command history implementation. Captures key up and key down * strokes to call command history and redefines the same events with control down to allow caret * vertical shift.
	 */
	protected void processKeyEvent(KeyEvent e) {
		...
		// history recall.
		else if ((e.getKeyCode() == KeyEvent.VK_DOWN || e.getKeyCode() == KeyEvent.VK_UP) && e.getID() == KeyEvent.KEY_PRESSED && e.isControlDown()) {
