...
class ConsoleDocument extends DefaultStyledDocument {
	...
	/*
	 * it looks like the positionBeforePrompt does not track when it started out as 0 and a insertString at location 0 occurs. It may be better to track the position after the prompt in stead
	 */
	...
	/**
	 * override the insertString to make sure everything typed ends up at the end or in the 'command line' using the proper font, and the newline is processed.
	 */
